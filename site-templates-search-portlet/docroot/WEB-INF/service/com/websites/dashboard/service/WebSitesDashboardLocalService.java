...
/**
 * Provides the local service interface for WebSitesDashboard. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author liferay
 * @see WebSitesDashboardLocalServiceUtil
...
public interface WebSitesDashboardLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WebSitesDashboardLocalServiceUtil} to access the web sites dashboard local service. Add custom service methods to {@link com.websites.dashboard.service.impl.WebSitesDashboardLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
