...
<%-- <portlet:actionURL var="siteDetails" name="siteDetails" windowState="<%=LiferayWindowState.EXCLUSIVE.toString()%>">
...
String[] assetDisplayStyle=StringUtil.split(displayStyle,',');
